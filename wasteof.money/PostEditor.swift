...
struct PostEditor: View, MarkupDelegate {
    ...
    @State var newPostId: Optional<String> = nil
    ...
    @ViewBuilder private var editor: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Button {
                    post(token: session.token, content: currenthtml, repost: nil)
                } label: {
                    HStack {
                        Text("Post")
    ...
    func post(token: String, content: String, repost: Optional<String>) {
